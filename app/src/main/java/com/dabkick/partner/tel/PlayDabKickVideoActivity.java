...
//        done = (TextView) findViewById(R.id.done_txt);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(com.dabkick.partner.tel.R.layout.activity_play_dab_kick_video);
        findViews();
...
//                showRelatedVideos();
        ...
        wathWIthFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dabkick.watchWithFriends(PlayDabKickVideoActivity.this, list, null, new Dabkick.OnWatchWithFriend() {
                    @Override
