...
public class Webb {
    ...
    /*
      ...
      <br/>
      The value can be overwritten by calling {@link com.dabkick.global.Web.Webb#setDefaultHeader(String, Object)} and/or
     ...
     * the URIs relatively. The value is only taken when {@link com.dabkick.sdk.Web.Webb#setBaseUri(String)} is not called or
    ...
    /*
      ...
      <br/>
      The value takes precedence over {@link com.dabkick.global.Web.Webb#setGlobalHeader(String, Object)} but can be overwritten by
      {@link com.goebl.david.Request#header(String, Object)}.
      <br/>
      For the supported types for values see {@link Request#header(String, Object)}.
